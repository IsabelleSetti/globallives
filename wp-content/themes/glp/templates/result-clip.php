<?php $clip_id = $clip->ID; ?>
<article id="clip-<?php echo $clip_id; ?>" data-participant="<?php echo $participant_id; ?>" class="result result-clip row hide">
	<div class="clip-thumbnail col-md-3 col-md-offset-2">
