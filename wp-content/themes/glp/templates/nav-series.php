		...
		<div id="series-carousel" class="carousel slide">
			<ul class="carousel-inner">
				<div class="item active row">
					<li class="series-thumbnail home-thumbnail col-md-2 active"><h4><?php echo $series->name; ?></h4><?php echo $series->count; ?> <?php _e('Lives'); ?></li>
					...
					<li class="series-thumbnail participant-thumbnail col-md-2" data-id="<?php echo $participant->ID; ?>"><img src="<?php the_participant_thumbnail_url( $participant->ID, 'small' ); ?>"></li>
					<?php endforeach; ?>
				</div>
				<div class="item row">
