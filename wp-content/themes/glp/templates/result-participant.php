...
<article id="participant-<?php echo $participant_id; ?>" data-gender="<?php the_participant_field('gender', $participant_id); ?>" data-age="<?php the_participant_field('age', $participant_id); ?>" data-income="<?php the_participant_field('income', $participant_id); ?>" data-region="<?php the_participant_field('continent', $participant_id); ?>" class="result result-participant row<?php foreach (get_participant_themes($participant_id) as $theme) { echo ' theme-' . $theme; } ?>">
	<div class="result-thumbnail col-md-2"><a href="<?php echo get_permalink($participant_id); ?>"><img src="<?php the_participant_thumbnail_url($participant_id); ?>"></a></div>
	<div class="result-meta col-md-10">
