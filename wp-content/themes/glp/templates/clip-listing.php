...
<article class="participant-clip-listing<?php echo strip_tags(get_the_term_list($clip->ID,'clip_tags',' ',' ')); ?>">
	<div class="row">
		<div class="clip-thumbnail col-md-2" data-clip-id="<?php echo $clip->ID; ?>">
		...
		<div class="">
			...
			<?php if ($download_url = get_field('download_url',$clip->ID)) : ?><a class="" href="<?php echo $download_url; ?>"><i class="fa fa-inverse fa-arrow-down"></i> Download</a><?php endif; ?>
