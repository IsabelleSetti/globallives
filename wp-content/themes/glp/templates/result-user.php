<?php $user_id = $user->ID; ?>
<article id="user-<?php echo $user_id; ?>" class="result result-user row">
	<div class="result-thumbnail col-md-2"><a href="<?php echo get_author_posts_url($user_id); ?>"><img src="<?php the_profile_thumbnail_url($user_id); ?>"></a></div>
